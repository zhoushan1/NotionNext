...
const Footer = ({ siteInfo }) => {
  ...
  return (
        ...
        >
            ...
            <div className='text-xs font-serif'>Powered By <a href='https://github.com/zhoushan1/NotionNext' className='underline text-gray-500 dark:text-gray-300'>NotionNext</a></div>
