...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是互联网冲浪金牌选手, Hi，我是国家一级赖床员,Hi，我是熬夜协会常任理事,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Aurora', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '简单可依赖', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notionext-three.vercel.app', // 网站地址
  ...
  // ----> 站点统计
  ANALYTICS_VERCEL: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL || false, // vercel自带的统计 https://vercel.com/docs/concepts/analytics/quickstart https://github.com/zhoushan1/NotionNext/issues/897
